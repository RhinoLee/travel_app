...
<template>
  <div v-if="placeDetail" :class="{ hidden: !isPanelOpen }" class="w-[300px] md:w-[358px] h-[calc(94vh-54px)]
      absolute left-1/2 md:left-[308px] top-[50%] -translate-y-[calc(50%-27px)] -translate-x-[50%] md:-translate-x-0 py-[14px] px-[20px] 
    ...
    <!-- 按鈕區 -->
    <div class="fixed top-0 left-0 flex items-center border-t border-travel-green px-[20px] w-full h-[64px] z-10  bg-travel-lightgreen">
      <!-- close btn -->
